...
class BiLSTM_CRF(nn.Module):
    ...
    def init_hidden(self):
        return (torch.randn(2, 1, self.hidden_dim // 2).to('cuda'),  # Here 1 is for batch_size
    ...
    # Takes input a single sentence and returns the tags
    # Here the sentence is already in embedding form
    ...
    # This acts like the usual pytorch forward function. We call this function during training.
    # Here the sentence is already in embedding form
